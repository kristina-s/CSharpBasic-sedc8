...
namespace Arrays
{
	class Program
	{
		...
		{
			#region Arrays
			// An empty array with 3 int elements
            ...
            // throws an exception because the array is set to 3 elements only
			//emptyIntArray[3] = 22;
			// Creating and initialization of an array
			string[] fullStringArray = new string[] { "Bob", "Jill", "Kenny", "March" };
